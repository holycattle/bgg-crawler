...
def get_comments(game_id):
    ...
    while current_page <= total_pages: 
        ...
        if current_page+1 > total_pages or (END > 0 and current_page+1 > END):
            break
